...
} from '@/types/api-services/user/responses';
...
export const UserService = {
    signup: createAsyncThunk<SignupResponse, SignupRequest, RejectOptions>(
        '/signUp',
        async ({ username, publicKey }, { rejectWithValue }) => {
            try {
    ...
    usernameCheck: createAsyncThunk<UsernameCheckResponse, UsernameCheckRequest, RejectOptions>(
        Points.UserNameCheck,
    ...
    recovery: createAsyncThunk<User, RecoveryRequest, RejectOptions>(
        Points.Recovery,
        async (recoveryDto, { rejectWithValue }) => {
            try {
